...
*How much energy (in kWh/yr) would be saved by switching to each of the more efficient appliances? ​[2 points]* 
 ...
 b = {'fridge': {'kwh/yr':380, 'price':780, 'lifetime_yr':10},
      'washer': {'kwh/yr':180, 'price':900, 'lifetime_yr':10},
      'dishwasher': {'kwh/yr':240, 'price':350, 'lifetime_yr':10}, 
      }
...
def cce(pair):
    ann_invest = U(pair['price'],0.05,pair['lifetime_yr'])
    return ann_invest / pair['savings']

for key, value in b.items():
     value['cce_savings'] = cce(value)
