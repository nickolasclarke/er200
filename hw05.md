...
```
**ANSERS:** Total Resistance 8.92 ohm
...
print('Power Losses in 1965: ' + format(P_loss_65_mw, '.1g') + ' mW')
print('Power Losses in 2012: ' + format(P_loss_12_mw, '.1g') + ' mW')

```

**ANSWERS:** 
Power Losses in 1965: ~5 mW
Power Losses in 2012: ~2 mW
...
print('1965 Power loss: '+ format(P_loss_65_perc,'.1%'))
print('2012 Power loss: '+ format(P_loss_12_perc,'.1%'))
```
...
**ANSWERS:** Since `P_loss = I^2 * R` and since `I = P / V`, as we increase voltage, and `P` and `R` remain constant, P_loss decreases. 
